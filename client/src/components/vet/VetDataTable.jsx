...
const VetDataTable = ({ columns = [], data = [], emptyTitle, emptyDescription }) => {
  if (!data.length) return <VetEmptyState title={emptyTitle} description={emptyDescription} />;
